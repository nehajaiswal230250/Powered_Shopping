...
const INPUT_FILE = path.resolve("docs/PROJECT_REPORT_DESIGNED.md");
const OUTPUT_FILE = path.resolve("docs/PROJECT_REPORT_DESIGNED.pdf");
...
const drawHeader = (pageNumber) => {
  ...
  drawText({
    text: "Powered Shopping  |  Designed Project Report",
    x: MARGIN_X,
    yTop: 31,
    size: 12,
    font: FONT_BOLD,
